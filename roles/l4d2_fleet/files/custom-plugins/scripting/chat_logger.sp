...
// this plugin echoes ONLY real player chat to the console with a unique [CHAT] tag,
// which journald ships to Loki, where the Grafana chat panel matches it exactly —
